...
/**
 * Pinned, full-screen sectional scroll experience. Each scroll step crossfades
 * the background, slides the centered title in word-by-word, and re-centers the
 * left/right label tracks. Ported from a Next.js (styled-jsx) original to plain
 * JSX + an external stylesheet; dynamic stage height travels as a CSS var.
 */
const FullScreenScrollFX = forwardRef(function FullScreenScrollFX(
  {
    sections,
    className,
    style,
  ...
  return (
    ...
    >
      ...
      <div className="fx-scroll">
        ...
        <div className="fx-end" aria-hidden="true" />
      </div>
    </div>
  );
});
